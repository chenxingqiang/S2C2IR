...
// Phase 3E: one semantic workload. IR does not encode keep/flatten.
// Compiler discovers three sched.concurrent candidates and decides.
// SSD → Host is sequential. Host→HBM || MLP is candidate #0.
...
// NPU-LOG-SAME: reason=licensed-evidence
// NPU-LOG: workload-schedule candidates=3 keep=2 flatten=1

// UNK-LOG: workload-candidate #0
// UNK-LOG-SAME: decision=KEEP
// UNK-LOG: workload-candidate #1
// UNK-LOG-SAME: decision=KEEP
// UNK-LOG: workload-candidate #2
// UNK-LOG-SAME: decision=KEEP
// UNK-LOG-NOT: decision=FLATTEN
// UNK-LOG: workload-schedule candidates=3 keep=3 flatten=0
...
// NPU-AN: workload-schedule keep=2
...
// UNK-AN: workload-schedule keep=3
