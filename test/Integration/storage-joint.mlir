...
// default-3g selects the historical 3G tuple and is frozen.
// Cost does not rank or license. No C||Storage flatten.
...
// GPU-LOG: hierarchy-joint #0 object=0 sites=0,2,3 legal=1
// GPU-LOG-SAME: selected=MATERIALIZE|MATERIALIZE|TRANSFER
// GPU-LOG: hierarchy-joint #1 object=1 sites=1,4,5,6,7 legal=8
// GPU-LOG-SAME: selected=MATERIALIZE|PREFETCH|TRANSFER|KEEP_RESIDENCY|KEEP_RESIDENCY
// GPU-LOG-SAME: policy=default-3g
// GPU-LOG-SAME: note default-3g-frozen
// GPU-LOG: hierarchy-joint-candidate #1
// GPU-LOG-SAME: actions=MATERIALIZE|PREFETCH|TRANSFER|KEEP_RESIDENCY|KEEP_RESIDENCY
// GPU-LOG: hierarchy-joint-schedule chains=2 legal=8
// GPU-LOG-SAME: selected-in-legal=yes
// GPU-LOG-SAME: policy=default-3g
// GPU-LOG-SAME: note selection-ne-cost
// GPU-LOG-NOT: FLATTEN

// UNK-LOG: hierarchy-joint #1 object=1 sites=1,4,5,6,7 legal=4
// UNK-LOG-SAME: selected=MATERIALIZE|PRESERVE|TRANSFER|KEEP_RESIDENCY|KEEP_RESIDENCY
