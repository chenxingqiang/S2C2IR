...
7B-Apply Controlled IR Apply         CLOSED; [`ir-apply-contract.md`](design/ir-apply-contract.md)
...
7B: [`storage-rewrite.md`](design/storage-rewrite.md).
...
IR apply stays closed. Contract (not inhabitant):
