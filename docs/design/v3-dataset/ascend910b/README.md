...
Host log: `../ssd-mlp-wallclock.log` (`measured=yes` on 910B).
The 4090 counterpart is `../ssd-mlp-wallclock-4090.log` and
does not overwrite this file.
Do not FileCheck microseconds. Do not invent a Cost ranking.
