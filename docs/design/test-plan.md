...
Design only. Reuses existing Score_3 numbers. Design:
[`search-pareto.md`](search-pareto.md).

| ID | File | Checks |
| -- | ---- | ------ |
| S1 | `test/Analysis/realization-space.mlir` R4 | argmin total is gpu (128 < 136) |
| S2 | `test/Analysis/s2c2-cost-cp.mlir` C6 / C9 | equal totals ⇒ both minima |
