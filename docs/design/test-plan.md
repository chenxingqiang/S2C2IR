...
| ALG-2 | same | `--print-evidence-algebra-matrix`; dest-inv does not enter usable Decision; three scope canonicals stay distinct; missing-ordering → `predicate.missing-input` |
