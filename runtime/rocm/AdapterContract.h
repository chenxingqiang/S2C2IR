//===- AdapterContract.h - ROCm capability adapter (no HIP) -----*- C++ -*-===//
//
...
#ifndef S2C2_RUNTIME_ROCM_ADAPTER_CONTRACT_H
#define S2C2_RUNTIME_ROCM_ADAPTER_CONTRACT_H

namespace s2c2 {
namespace rocm_adapter {
